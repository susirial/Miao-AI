...
export const columns: ColumnDef<Task>[] = [
  {
    ...
    header: ({ table }) => h(Checkbox, {
      ...
      'onUpdate:modelValue': (value: CheckboxRootEmits['update:modelValue'][0]) => table.toggleAllPageRowsSelected(!!value),
      'ariaLabel': 'Select all',
      'class': 'translate-y-0.5',
    }),
    cell: ({ row }) => h(Checkbox, {
      'modelValue': row.getIsSelected(),
      'onUpdate:modelValue': (value: CheckboxRootEmits['update:modelValue'][0]) => row.toggleSelected(!!value),
